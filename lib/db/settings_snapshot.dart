...
final class SettingsSnapshot {
  ...
  List<int> encode() => Uint8List.fromList(
    utf8.encode(
      jsonEncode({'formatVersion': currentVersion, 'values': values}),
    ),
  );
