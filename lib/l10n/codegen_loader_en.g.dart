...
const Map<String, dynamic> translations = {
  ...
  "until": "until",
  "ifRedeemedBeforeThisDate": "if redeemed before this date",
  ...
  "New loans have no lock-in by default":
      "New loans have no lock-in by default",
  "showUpiPaymentQr": "Show UPI payment QR",
  "createUpiPaymentQr": "Create UPI payment QR",
  ...
  "defaultUpiIdHelper":
      "Prefilled when creating a UPI payment; you can still edit it there.",
  "defaultUpiIdUpdated": "Default UPI ID updated",
  "amount": "Amount",
  "enterAmountGreaterThanZero": "Enter an amount greater than zero",
  "createQr": "Create QR",
  "loanRepaymentFor": "Loan repayment - {name}",
  "scanToPayWithUpi": "Scan to pay with UPI",
  "verifyUpiRecipient":
  ...
  "phoneLoginPrompt": "Enter your phone number to continue",
  "phoneNumber": "Phone number",
  "continueAction": "Continue",
  "validMobileNumberHelper": "Use a valid mobile number to continue.",
  ...
  "phoneVerificationUnavailable":
      "Phone verification is not available yet. Please try again later.",
  "couldNotSendCode":
      "We couldn't send the code. Check your connection and try again.",
  "invalidVerificationCode":
      "That code is not valid. Please check it and try again.",
  "couldNotVerifyCode": "We couldn't verify the code. Please try again.",
  ...
  "Find lenders": "Find lenders",
  "Find lenders near you": "Find lenders near you",
  "Discover lenders near you": "Discover lenders near you",
  ...
  "City": "City",
  "Pincode": "Pincode",
  "Locality or neighbourhood": "Locality or neighbourhood",
  "Pincode or postal code": "Pincode or postal code",
  "For example, Indiranagar": "For example, Indiranagar",
  "For example, Bengaluru": "For example, Bengaluru",
  "For example, 560038": "For example, 560038",
  "Enter an area to search": "Enter an area to search",
  ...
  "Searching…": "Searching…",
  "Clear": "Clear",
  "Choose where to search": "Choose where to search",
  ...
  "LoanX helps you discover lenders. It does not guarantee a lender or approve, disburse, or collect a loan.":
      "LoanX helps you discover lenders. It does not guarantee a lender or approve, disburse, or collect a loan.",
  "My loans": "My loans",
  "My lenders": "My lenders",
  "My borrowers": "My borrowers",
  ...
  "Reverse": "Reverse",
  "Amount": "Amount",
  "Borrowers could not be loaded": "Borrowers could not be loaded",
  "No borrowers yet": "No borrowers yet",
  "No connected lenders": "No connected lenders",
  "LoanX lender": "LoanX lender",
  "Lender notifications": "Lender notifications",
  "No lender notifications": "No lender notifications",
  "Loans from LoanX lenders": "Loans from LoanX lenders",
  "No connected loans": "No connected loans",
  "Loans issued to you by connected LoanX lenders will appear here.":
      "Loans issued to you by connected LoanX lenders will appear here.",
  "Borrowing": "Borrowing",
  "Report profile": "Report profile",
  "Block lender": "Block lender",
  "Reason": "Reason",
  "Enter at least 10 characters": "Enter at least 10 characters",
  ...
  "This profile will no longer appear in your searches.":
      "This profile will no longer appear in your searches.",
  "Block": "Block",
  "Lender blocked": "Lender blocked",
  "Action could not be completed": "Action could not be completed",
  "Public lender profile": "Public lender profile",
  ...
  "Public profile could not be loaded. Connect and try again.":
      "Public profile could not be loaded. Connect and try again.",
  "Public profile saved": "Public profile saved",
  "Public profile could not be saved": "Public profile could not be saved",
  "Public name": "Public name",
  "Enter 2–120 characters": "Enter 2–120 characters",
  "Currency": "Currency",
  ...
  "Publish in lender search": "Publish in lender search",
  "You can unpublish this profile at any time.":
      "You can unpublish this profile at any time.",
  "Enter a valid amount": "Enter a valid amount",
  "Load more lenders": "Load more lenders",
  "Loading…": "Loading…",
