...
class _PhoneLoginScreenState extends State<PhoneLoginScreen> {
  ...
  void initState() {
    super.initState();
    _phoneFocusNode.addListener(_scrollPhoneFieldIntoView);
    _loadCountryDefault();
  }

  void _scrollPhoneFieldIntoView() {
    if (!_phoneFocusNode.hasFocus) return;

    // Wait for the keyboard inset to be applied before calculating the scroll
    // position. This keeps the active input above the keyboard on short
    // screens as well as when the user has increased text size.
  ...
  void dispose() {
    _phoneFocusNode
      ..removeListener(_scrollPhoneFieldIntoView)
      ..dispose();
