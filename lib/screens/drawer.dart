                                  ...
                                  return Slider(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      if (value.toInt() !=
                                        ...
                                        ref
                                            .read(
                                              holdingPeriodProvider.notifier,
                                            )
                                            .set(value.toInt());
                                      }
                                    },
                                      ...
                                      itemBuilder: (context, index) {
                                        return RadioListTile(
                                          ...
                                          title: StyledSubtitle(
                                            InterestType.values[index].name
                                                .toSentenceCase(),
                                          ),
                                        );
                                      },
                                      ...
                                      return CupertinoPicker(
                                        ...
                                        scrollController:
                                            FixedExtentScrollController(
                                              initialItem: interestRate.toInt(),
                                            ),
                                        selectionOverlay:
                                    ...
                                    return OutlinedButton(
                                      onPressed: () async {
                                        if (interestRateString[1].length > 2) {
                                          interestRateString[1] =
                                              interestRateString[1].substring(
                                                0,
                                                2,
                                              );
                        ...
                        onTap: () async {
                          ref
                              ...
                              .when(
                                ...
                                error: (err, obj) => showErrorSnackBar(
                                  context,
                                  "An Error occured, Please try again later",
                                ),
                                loading: () => showErrorSnackBar(
                                  context,
                                  "Please wait ...",
                                ),
                              );
