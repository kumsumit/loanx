...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 726828554;
...
fn wire__crate__api__network__lookup_borrower_profile_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "lookup_borrower_profile",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(
                            crate::api::network::lookup_borrower_profile(
                                api_server_address,
                                api_server_name,
                                api_trusted_certificate_pem,
                                api_device_id,
...
fn wire__crate__api__network__pull_changes_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(
                            crate::api::network::pull_changes(
                                api_server_address,
                                api_server_name,
                                api_trusted_certificate_pem,
                                api_device_id,
...
fn wire__crate__api__network__save_borrower_lookup_profile_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "save_borrower_lookup_profile",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_device_id = <String>::sse_decode(&mut deserializer);
            let api_access_token = <String>::sse_decode(&mut deserializer);
            let api_searchable_by_phone = <bool>::sse_decode(&mut deserializer);
            let api_display_name = <String>::sse_decode(&mut deserializer);
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(
                            crate::api::network::save_borrower_lookup_profile(
                                api_server_address,
                                api_server_name,
                                api_trusted_certificate_pem,
                                api_device_id,
                                api_access_token,
                                api_searchable_by_phone,
                                api_display_name,
                                api_address,
                            )
                            .await,
...
impl SseDecode for crate::api::network::BorrowerProfileLookup {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_success = <bool>::sse_decode(deserializer);
        ...
        let mut var_errorMessage = <Option<String>>::sse_decode(deserializer);
        return crate::api::network::BorrowerProfileLookup {
            success: var_success,
            found: var_found,
...
impl SseDecode for Vec<crate::api::network::SyncChange> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = Vec::with_capacity(len_ as usize);
        for idx_ in 0..len_ {
            ans_.push(<crate::api::network::SyncChange>::sse_decode(deserializer));
        }
        return ans_;
    }
}
...
impl SseDecode for crate::api::network::PullChangesResult {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_success = <bool>::sse_decode(deserializer);
        let mut var_changes = <Vec<crate::api::network::SyncChange>>::sse_decode(deserializer);
        let mut var_nextSequence = <i64>::sse_decode(deserializer);
        let mut var_hasMore = <bool>::sse_decode(deserializer);
        let mut var_errorMessage = <Option<String>>::sse_decode(deserializer);
        return crate::api::network::PullChangesResult {
            success: var_success,
            changes: var_changes,
...
impl SseDecode for crate::api::network::SyncChange {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        let mut var_entityRevision = <i64>::sse_decode(deserializer);
        let mut var_payloadJson = <Vec<u8>>::sse_decode(deserializer);
        let mut var_createdAtMs = <i64>::sse_decode(deserializer);
        return crate::api::network::SyncChange {
            sequence: var_sequence,
            entity_type: var_entityType,
            entity_id: var_entityId,
            operation: var_operation,
            entity_revision: var_entityRevision,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        6 => wire__crate__api__network__list_shared_loans_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__network__logout_session_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__network__lookup_borrower_profile_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        18 => wire__crate__api__network__save_borrower_lookup_profile_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::network::BorrowerProfileLookup {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.success.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::network::BorrowerProfileLookup
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::network::BorrowerProfileLookup>
    for crate::api::network::BorrowerProfileLookup
{
    fn into_into_dart(self) -> crate::api::network::BorrowerProfileLookup {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::network::PullChangesResult {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.success.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::network::PullChangesResult
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::network::PullChangesResult>
    for crate::api::network::PullChangesResult
{
    fn into_into_dart(self) -> crate::api::network::PullChangesResult {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::network::SyncChange {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.entity_revision.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::network::SyncChange
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::network::SyncChange>
    for crate::api::network::SyncChange
{
    fn into_into_dart(self) -> crate::api::network::SyncChange {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::network::BorrowerProfileLookup {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.success, serializer);
...
impl SseEncode for Vec<crate::api::network::SyncChange> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::network::SyncChange>::sse_encode(item, serializer);
        }
    }
}
...
impl SseEncode for crate::api::network::PullChangesResult {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.success, serializer);
        <Vec<crate::api::network::SyncChange>>::sse_encode(self.changes, serializer);
        <i64>::sse_encode(self.next_sequence, serializer);
...
impl SseEncode for crate::api::network::SyncChange {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <i64>::sse_encode(self.entity_revision, serializer);
        <Vec<u8>>::sse_encode(self.payload_json, serializer);
